...
public class Super_Market_Weekly_Offer {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Welcome to the ARUN Supermarket!");
            System.out.println("--------------------------------");
        ...
        private static void initializeItemPrices() {
            ...
            if (d.getDay() == 3) {
                ...
                itemPrices.put("Apple", (double) 155);
                itemPrices.put("Banana", (double) 4);
                itemPrices.put("Oil", (double) 80);
                itemPrices.put("Sugar", (double) 80);
                itemPrices.put("Rice", (double) 60);
                itemPrices.put("Dhall", (double) 100.50);
                itemPrices.put("Tamarind", (double) 50.70);
                itemPrices.put("Maggie", (double) 15.50);

            } else {
                itemPrices.put("Apple", (double) 200);
